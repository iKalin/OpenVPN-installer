...
You can get a cheap VPS to run this script for $3.35/month worldwide at [OVH](https://www.ovh.com) or €3.90/month for unlimited bandwidth in Germany at [Hetzner](https://www.hetzner.com).

First, get the script and make it executable :

```
wget https://raw.githubusercontent.com/DevinDevoir/OpenVPN-install/master/openvpn-install.sh
...
- Run server in [unprivileged mode](https://github.com/DevinDevoir/OpenVPN-install/blob/master/openvpn-install.sh#L426), reducing risks to the system
...
[MIT Licence](https://raw.githubusercontent.com/DevinDevoir/openvpn-install/master/LICENSE)
