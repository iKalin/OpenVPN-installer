...
# https://github.com/DevinDevoir/OpenVPN_install-script
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	do
	clear
		echo "OpenVPN-install (github.com/DevinDevoir/OpenVPN-installer)"
		echo ""
	...
	clear
	echo "Welcome to the secure OpenVPN installer (github.com/DevinDevoir/OpenVPN-installer)"
	echo ""
	...
	echo ""
	echo "See https://github.com/DevinDevoir/OpenVPN-installer#encryption to learn more about "
